              ...
              >
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex-1 p-6 sm:p-7">
                    ...
                    {details.length > 0 ? (
                      <dl className="mt-4 grid grid-cols-1 gap-y-2 text-sm text-zinc-800 dark:text-zinc-400 sm:grid-cols-2 sm:gap-x-6">
                        {details.map((d) => (
                          <div key={d.key} className="flex gap-2">
                            <dt className="min-w-28 font-medium text-zinc-900 dark:text-zinc-300">
                              {d.key}
                            </dt>
